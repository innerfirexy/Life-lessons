...
class Queue(multiprocessing.queues.Queue):
    ...
    def __init__(self, *args, **kwargs):
        super(Queue, self).__init__(*args, **kwargs, ctx=multiprocessing.get_context()) # A fix: https://stackoverflow.com/questions/24941359/ctx-parameter-in-multiprocessing-queue
        self.size = SharedCounter(0)
    
    # The following two fixes are from: https://gist.github.com/FanchenBao/d8577599c46eab1238a81857bb7277c9
